...
{ 
  ...
  static fcjson sessionInfo (const RequestStatus status, const SessionToken& token, const bool shared, bool expires, const SessionDuration duration, SessionExpireTimeUnit expireTime, const std::size_t keyCount)
  {
